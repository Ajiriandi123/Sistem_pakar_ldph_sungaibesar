        ...
        <section class="login_content">
          <form method="post" action="<?= base_url('auth/registrasi') ?>">
            ...
            <div class="separator">
              ...
              <div>
                <h1><i class="fa fa-desktop"></i> SISPAK-LDPH</h1>
                <p>©2024 Sistem Pakar Pendeteksi Skala Kerusakan Hutan - Aji Riandi Kurniawan - Teknik Informatika FTIK - UM Pontianak</p>
              </div>
            </div>
          </form>
        </section>
