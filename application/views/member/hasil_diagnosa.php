<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html"><sp>SISPAK-LDPH</a>
      ...
      <div class="row">
        <div class="col-lg">
          ...
          <div class="page three">
            ...
            <div class="row progress-circle mb-5">
              <?php foreach ($diagnosa as $diag) : ?>
                ...
                if ($diag['id_kerusakan'] == 1) {
                  $diag['id_kerusakan'] = 'Tutupan Hutan Masih Ada';
                } elseif ($diag['id_kerusakan'] == 2) {
                  $diag['id_kerusakan'] = 'Hutan Terdegradasi';
                } elseif ($diag['id_kerusakan'] == 3) {
                  $diag['id_kerusakan'] = 'Hutan Terfragmentasi Habitat';
                } elseif ($diag['id_kerusakan'] == 4) {
                  $diag['id_kerusakan'] = 'Hutan Dampak Perubahan Iklim';
                } elseif ($diag['id_kerusakan'] == 5) {
                  $diag['id_kerusakan'] = 'Hutan Terdeforestasi';
                }
            ...
            <div class="row">
              <h4>Berdasarkan Gejala-Gejala yang telah dipilih,maka kondisi kawasan hutan berdasarkan data yang telah di temukan, maka hutan diwilayah tersebut mengalami:</h4>
              <br>
              <?php foreach ($tertinggi as $tinggi) : ?>
                <?php
                if ($tinggi['id_kerusakan'] == 1) {
                  $tinggi['id_kerusakan'] = 'Tutupan Hutan Masih Ada';
                } elseif ($tinggi['id_kerusakan'] == 2) {
                  $tinggi['id_kerusakan'] = 'Hutan Terdegradasi';
                } elseif ($tinggi['id_kerusakan'] == 3) {
                  $tinggi['id_kerusakan'] = 'Hutan Mengalami Fragmentasi Habitat';
                } elseif ($tinggi['id_kerusakan'] == 4) {
                  $tinggi['id_kerusakan'] = 'Hutan Mengalami Perubahan Iklim';
                } elseif ($tinggi['id_kerusakan'] == 5) {
                  $tinggi['id_kerusakan'] = 'Hutan Terdeforestasi';
                }
                ...
                <div class="col-md-8 d-flex ftco-animate">
                  <div class="blog-entry justify-content-end">
                    ...
                    <div class="text mt-3 float-right d-block">
                      <h4>Solusi yang harus dilakukan : </h4>
                      <p><?= $det['solusi']; ?></p>
                    </div>
                  </div>
                </div>
